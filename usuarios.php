...
if($activar_busqueda_inicial){
	 ...
	 LEFT JOIN c_estado_registro ON c_usuario.estado_registro_id = c_estado_registro.estado_registro_id";
...
<body>
	...
	<!--este campo vacio almacena el rol guardado desde el php-->
		...
		<div class="container-login100">
			...
			<div class="wrap-login100">
				...
				<div class="container-fluid">
				  <div class="row">
				    <div class="col-sm-3">
				       <div class="my_titulo"><h1>Catálogo de Usuarios</h1></div>
				    </div>
				...
				<div style="/*overflow: auto; white-space: nowrap;*/">
					<table id="my_table_sorter" class="table table-bordered table-striped">
						<thead class="thead-dark"> <!-- add class="thead-light" for a light header -->
							<tr>
								<th><input type="checkbox" id="checkbox_all_registers" data-toggle="popover"  title="" data-placement="left" data-content="" data-html="true">&nbsp;&nbsp;#</th>
								<th>ID BD</th>
								<th>Fecha Registro</th>
								<th class="filter-match">RPE</th>
								<th class="filter-match">Nombres</th>
								<th class="filter-match">Apellido Paterno</th>
								<th class="filter-match">Apellido Materno</th>
								<th class="filter-match">Email</th>
								<th class="filter-select filter-exact">Habilitado</th>
								<th class="filter-select filter-exact">Estado Registro</th>
								<th>Acciones</th> <!-- con los atributos data-sorter="false" data-filter="false" desabilita el filtro, o la class="sorter-false filter-false" -->
							</tr>								
						</thead>
						<tfoot>
							<tr>
							...
							if($activar_busqueda_inicial){
								...
								if(count($records)>0){
									...
									foreach($records as $record){							
										...
										echo '<tr>';
										echo '<td><input type="checkbox" id="checkbox_reg_'.$record->usuario_id.'">&nbsp;&nbsp;' . ($contador++) .'</td>';
										echo '<td>'. $record->usuario_id.'</td>';
										echo '<td>'.$record->fecha_registro.'</td>';
										echo '<td><div id="reg_div_id_'.$record->usuario_id.'">'.$record->rpe.'</div></td>';
										echo '<td>'.$record->nombres.'</td>';
										echo '<td>'.$record->apellido_paterno.'</td>';
										echo '<td>'.$record->apellido_materno.'</td>';
										echo '<td>'.$record->email.'</td>';
										echo '<td habilitado="'.$record->habilitado.'">'. (($record->habilitado=='1')? 'Si':'No') .'</td>';
										echo '<td estado_registro_id="'.$record->estado_registro_id.'"><div>'.$record->estado_registro_nombre.'</div></td>';
										echo '<td>'; 
										
										//botones de duplicar
										if($activar_funcion_duplicar){
											echo '<button type="button" id="btn_duplicar_cascada_' . $record->usuario_id . '" class="btn my_btn btn-light btn_duplicar_cascada" data-container="body" data-toggle="popover" title=""  data-placement="left" data-content="" ' . $enable_component . '>';
											echo '<img class="icons24x24" src="images/icons/32x32/application_cascade.png" />';
											echo '</button>';
											
											echo '<button type="button" id="btn_duplicar_actualizar_' . $record->usuario_id . '" class="btn my_btn btn-light btn_duplicar_actualizar" data-container="body" data-toggle="popover" title=""  data-placement="left" data-content="" '.$enable_component.'>';
											echo '<img class="icons24x24" src="images/icons/32x32/application_double.png" />';
											echo '</button>';
										}

										echo '<button type="button" id="btn_editar_' . $record->usuario_id . '" class="btn my_btn btn-light btn_editar" data-container="body" data-toggle="popover" title=""  data-placement="left" data-content="" '.$enable_component.'>';
										echo '<img class="icons24x24" src="images/icons/32x32/application_edit.png" />';
										echo '</button>';
										
										echo '<button type="button" id="btn_borrar_' . $record->usuario_id . '" class="btn my_btn btn-light btn_borrar" data-container="body" data-toggle="popover" title=""  data-placement="left" data-content="" '.$enable_component.'>';
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		   ...
		   <div class="form-group">
		  		...
		  		<div class="my_modal_campo_container">
		  			<div class="my_modal_campo_label"><label for="tb_rpe_id">RPE *</label></div>
		  			<div class="my_modal_campo"><input type="text" class="form-control my_form-control" id="tb_rpe_id" name="tb_rpe" value=""></div>
		  		</div>

		  		<div class="my_modal_campo_container">
		  			<div class="my_modal_campo_label"><label for="tb_nombres_id">Nombres *</label></div>
		  			<div class="my_modal_campo"><input type="text" class="form-control my_form-control" id="tb_nombres_id" name="tb_nombres" value=""></div>
		  		</div>

		  		<div class="my_modal_campo_container">
		  			<div class="my_modal_campo_label"><label for="tb_apellido_paterno_id">Apellido Paterno *</label></div>
		  			<div class="my_modal_campo"><input type="text" class="form-control my_form-control" id="tb_apellido_paterno_id" name="tb_apellido_paterno" value=""></div>
		  		</div>

		  		<div class="my_modal_campo_container">
		  			<div class="my_modal_campo_label"><label for="tb_apellido_materno_id">Apellido Materno</label></div>
		  			<div class="my_modal_campo"><input type="text" class="form-control my_form-control" id="tb_apellido_materno_id" name="tb_apellido_materno" value=""></div>
		  		</div>

		  		<div class="my_modal_campo_container">
		  			<div class="my_modal_campo_label"><label for="tb_email_id">Email</label></div>
		  			<div class="my_modal_campo"><input type="text" class="form-control my_form-control" id="tb_email_id" name="tb_email" value=""></div>
		  		</div>

		  		<div class="my_modal_campo_container">
		  			<div class="my_modal_campo_label"><label for="se_habilitado_id">Habilitado</label></div>
		  			<div class="my_modal_campo">
		  				<select class="form-control my_form-control" id="se_habilitado_id">
		  		...
		  		<div class="my_modal_campo_container">
			  		...
			  		<div class="my_modal_campo"><select class="form-control my_form-control" id="se_estado_registro_id">
					    	<?php
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		   ...
		   <div class="form-group">
		  		...
		  		<div class="my_modal_campo_container">
		  			<div class="my_modal_buscar_cb" style="height: 36px;"><input type="checkbox" id="cb_buscar_campo_rpe"></div>
		  			<div class="my_modal_campo_label"><label for="tb_buscar_campo_rpe_id">RPE</div>
		  			<div class="my_modal_campo"><input type="text" class="form-control my_form-control" id="tb_buscar_campo_rpe_id" name="tb_buscar_campo_rpe" value="" disabled></div>
		  		</div>

		  		<div class="my_modal_campo_container">
		  			<div class="my_modal_buscar_cb" style="height: 36px;"><input type="checkbox" id="cb_buscar_campo_nombres"></div>
		  			<div class="my_modal_campo_label"><label for="tb_buscar_campo_nombres_id">Nombres</div>
		  			<div class="my_modal_campo"><input type="text" class="form-control my_form-control" id="tb_buscar_campo_nombres_id" name="tb_buscar_campo_nombres" value="" disabled></div>
		  		</div>

		  		<div class="my_modal_campo_container">
		  			<div class="my_modal_buscar_cb" style="height: 36px;"><input type="checkbox" id="cb_buscar_campo_apellido_paterno"></div>
		  			<div class="my_modal_campo_label"><label for="tb_buscar_campo_apellido_paterno_id">Apellido Paterno</div>
		  			<div class="my_modal_campo"><input type="text" class="form-control my_form-control" id="tb_buscar_campo_apellido_paterno_id" name="tb_buscar_campo_apellido_paterno" value="" disabled></div>
		  		</div>

		  		<div class="my_modal_campo_container">
		  			<div class="my_modal_buscar_cb" style="height: 36px;"><input type="checkbox" id="cb_buscar_campo_apellido_materno"></div>
		  			<div class="my_modal_campo_label"><label for="tb_buscar_campo_apellido_materno_id">Apellido Materno</div>
		  			<div class="my_modal_campo"><input type="text" class="form-control my_form-control" id="tb_buscar_campo_apellido_materno_id" name="tb_buscar_campo_apellido_materno" value="" disabled></div>
		  		</div>

		  		<div class="my_modal_campo_container">
		  			<div class="my_modal_buscar_cb" style="height: 36px;"><input type="checkbox" id="cb_buscar_campo_email"></div>
		  			<div class="my_modal_campo_label"><label for="tb_buscar_campo_email_id">Email</div>
		  			<div class="my_modal_campo"><input type="text" class="form-control my_form-control" id="tb_buscar_campo_email_id" name="tb_buscar_campo_email" value="" disabled></div>
		  		</div>

		  		<div class="my_modal_campo_container">
		  			<div class="my_modal_buscar_cb" style="height: 53px;"><input type="checkbox" id="cb_buscar_campo_habilitado"></div>
		  			<div class="my_modal_campo_label"><label for="se_buscar_campo_habilitado_id">Habilitado</label></div>
		  			<div class="my_modal_campo">
		  				<select class="form-control my_form-control" id="se_buscar_campo_habilitado_id" disabled>
					    	<option value="1">Si</option>
					    	<option value="0">No</option>
						</select>
					 </div>
		  		...
		  		<div class="my_modal_campo_container">
			  		...
			  		<div class="my_modal_campo">
			  			<select class="form-control my_form-control" id="se_buscar_campo_estado_registro_id" disabled>
					    	<?php
								if( count($records_estado_registro) > 0 ){
									$contador = 1;
									foreach($records_estado_registro as $record){
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		  ...
		  <div class="form-group">
		    <textarea rows="10" cols="64">registros</textarea> 
		  </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
      ...
      <div class="modal-body">
		 ...
		 <div class="form-group"  style="padding-left: 20px;">
        	...
        	<div style="display: flex; align-items: center;"><input type="checkbox" id="cb_modal_seleccion_campo_fecha_registro" my_campo_tabla="3"><label>&nbsp;&nbsp;Fecha Registro</label></div>
		  	<div style="display: flex; align-items: center;"><input type="checkbox" id="cb_modal_seleccion_campo_rpe" my_campo_tabla="4"><label>&nbsp;&nbsp;RPE</label></div>
		  	<div style="display: flex; align-items: center;"><input type="checkbox" id="cb_modal_seleccion_campo_nombres" my_campo_tabla="5"><label>&nbsp;&nbsp;Nombres</label></div>
		  	<div style="display: flex; align-items: center;"><input type="checkbox" id="cb_modal_seleccion_campo_apellido_paterno" my_campo_tabla="6"><label>&nbsp;&nbsp;Apellido Paterno</label></div>
		  	<div style="display: flex; align-items: center;"><input type="checkbox" id="cb_modal_seleccion_campo_apellido_materno" my_campo_tabla="7"><label>&nbsp;&nbsp;Apellido Materno</label></div>
		  	<div style="display: flex; align-items: center;"><input type="checkbox" id="cb_modal_seleccion_campo_email" my_campo_tabla="8"><label>&nbsp;&nbsp;Email</label></div>
		  	<div style="display: flex; align-items: center;"><input type="checkbox" id="cb_modal_seleccion_campo_habilitado" my_campo_tabla="9"><label>&nbsp;&nbsp;Habilitado</label></div>
		  	<div style="display: flex; align-items: center;"><input type="checkbox" id="cb_modal_seleccion_campo_estado_registro" my_campo_tabla="10"><label>&nbsp;&nbsp;Estado Registro </label></div>
      	</div>
      	</div>
      	<div class="modal-footer">
        	<button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
