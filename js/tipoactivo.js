$(function() {
	...
	var ejecutarBuscarRegistrosAjax = function(id, nombre, descripcion, fecha_registro_inicial, fecha_registro_final, estado_registro_id){
    	...
    	$.ajax({
            url : 'ajax_tipoactivo.php',    // la URL para la petición
    	    ...
    	    success: function (data, status, xhr) {
    	    	...
    	    	for(var i=0 ; i<records.length ; i++){
						...
						contenido += "<tr>";
    	    			contenido += '<td><input type="checkbox" id="checkbox_reg_'  + tipo_activo_id + '">&nbsp;&nbsp;' + (i+1) + '</td>';
    	    			contenido += '<td>' + tipo_activo_id + '</td>';
    	    			contenido += '<td>' + fecha_registro + '</td>';
    	    			contenido += '<td><div id="reg_div_id_' + tipo_activo_id + '">' + nombre +'</div></td>';
