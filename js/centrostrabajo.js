$(function() {
    ...
    var numero_filtros_tabla = 6; //se usa cuando se agregan popovers a los filtros, en la funcion pintarPopoversSobreFiltrosTabla()


	var columna_estado_registros = 6; //es para saber en que columa estan mostrados el estado d¿registro, para poder apuntar y tomar ese valoir para pintar colores.
	var columna_botones_acciones = 7; //es para saber en que columa estan mostrados los botones de las acciones.
	...
	var ejecutarBuscarRegistrosAjax = function(id, nombre, descripcion, fecha_registro_inicial, fecha_registro_final, estado_registro_id){
    	...
    	$.ajax({
            url : 'ajax_centrostrabajo.php',    // la URL para la petición
    	    ...
    	    success: function (data, status, xhr) {
    	    	...
    	    	for(var i=0 ; i<records.length ; i++){
						...
						contenido += "<tr>";
    	    			contenido += '<td><input type="checkbox" id="checkbox_reg_'  + centro_trabajo_id + '">&nbsp;&nbsp;' + (i+1) + '</td>';
    	    			contenido += '<td>' + centro_trabajo_id + '</td>';
    	    			contenido += '<td>' + fecha_registro + '</td>';
    	    			contenido += '<td><div id="reg_div_id_' + centro_trabajo_id + '">' + nombre +'</div></td>';
    	    			...
    	    			if(activar_funcion_duplicar){	 
	    	    			contenido += '<button type="button" id="btn_duplicar_cascada_' + centro_trabajo_id + '" class="btn my_btn btn-light btn_duplicar_cascada" \
							...
							contenido += '</button>';
							contenido += '<button type="button" id="btn_duplicar_actualizar_' + centro_trabajo_id + '" class="btn my_btn btn-light btn_duplicar_actualizar" \
	    	    			               data-container="body" data-toggle="popover" title=""  data-placement="left" data-content="">';
							contenido += '<img class="icons24x24" src="images/icons/32x32/application_double.png" />';
							contenido += '</button>';
						}//end botones de duplicar

						contenido += '<button type="button" id="btn_editar_' + centro_trabajo_id + '" class="btn my_btn btn-light btn_editar" \
						               data-container="body" data-toggle="popover" title=""  data-placement="left" data-content="" />';
						contenido += '<img class="icons24x24" src="images/icons/32x32/application_edit.png" />';
						contenido += '</button>';
						contenido += '<button type="button" id="btn_borrar_' + centro_trabajo_id + '" class="btn my_btn btn-light btn_borrar" \
						               data-container="body" data-toggle="popover" title=""  data-placement="left" data-content="" />';
	...
	var cargarUltimaBusquedaTableSorterAjax = function(){
    	...
    	var estado_registro_id   = busqueda_parametros[5]; 
    	 
    	ejecutarBuscarRegistrosAjax( id, nombre, descripcion, fecha_registro_inicial, fecha_registro_final, estado_registro_id); 	
	}
	...
	var definirBotonVerRegistroVerVentanaModal = function(){
		$( "[id^='reg_div_id_']").click(function() {
			...
			$("#modal_nuevo_edit_duplicar_borrar .modal-title").html("Cat. de Centros de Trabajo - Ver Registro");//titulo de la ventana
	...
	var definirBotonDuplicarCascada = function(){
		...
		$( ".btn_duplicar_cascada" ).click(function() {
		    ...
		    //var registro_id = $(this).parent().parent().find("td:nth-child(6)").attr("estado_registro_id");
	...
	var definirBotonDuplicarActualizar = function(){
		...
		$( ".btn_duplicar_actualizar" ).click(function() {
		    ...
		    //alert(renglon_estado_registro_id);
			$("#modal_nuevo_edit_duplicar_borrar .modal-title").html("Cat. de Centros de Trabajo - Dupicar Registro");//titulo de la ventana
	...
	var definirBotonEditarMostrarVentanaModal = function(){
		$( ".btn_editar" ).click(function() {
		    ...
		    //alert(renglon_estado_registro_id);
			$("#modal_nuevo_edit_duplicar_borrar .modal-title").html("Cat. de Centros de Trabajo - Editar Registro");//titulo de la ventana
...
//boton borrar -----------------------------------------
	var definirBotonBorrarMostrarVentanaModal = function(){	
		...
		$( ".btn_borrar" ).click(function() {
		    ...
		    //alert(renglon_estado_registro_id);
			$("#modal_nuevo_edit_duplicar_borrar .modal-title").html("Cat. de Centros de Trabajo - Borrar Registro");//titulo de la ventana
	...
	$( "#btn_buscar_base_datos" ).click(function() {
			...
			$("#modal_buscar .modal-title").html("Cat. de Centros de Trabajo - Buscar Registro");//titulo de la ventana
	...
	$( "#btn_mostrar_modal_nuevo_registro" ).click(function() {
			...
			$("#modal_nuevo_edit_duplicar_borrar .modal-title").html("Cat. de Centros de Trabajo - Nuevo Registro");//titulo de la ventana
	...
	$( "#btn_mostrar_modal_borrar_bloque_registro" ).click(function() {
			...
			$("#modal_borrar .modal-title").html("Cat. de Centros de Trabajo - Borar Registros Seleccionados");//titulo de la ventana
	...
	$( "#btn_editar_ejecutar" ).click(function() {
			...
			var nombre = $('#tb_nombre_id').val(); //input text nombre inicializado a espacio en blanco (es un componente input por eso se ocupa val)
			var descripcion = $('#ta_descripcion_id').val(); //text area descripcion inicializado a espacio en blanco (es un componente que finciona con contenido html)
			var estado_registro_id = $('#se_estado_registro_id').val(); //1 nuevo
	...
	$( "#btn_buscar_ejecutar" ).click(function() {
    	...
    	busqueda_parametros[5] = estado_registro_id; 
...
//evento check para habilitar o deshabilitar popovers------
	...
	var initElements = function(){
		...
		$(".my_titulo").css("color", color_distintivo_centros_trabajo_texto);
		$(".my_titulo").css("background-color", color_distintivo_centros_trabajo_fondo); //asignamos el color de la barra distintiva en las modales

		//barra distintiva en ventanas -----------------------------
		$(".barra_distintiva_color").css("background-color", color_distintivo_centros_trabajo_fondo); //asignamos el color de la barra distintiva en las modales
	}
