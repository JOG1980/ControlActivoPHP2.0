...
if($activar_busqueda_inicial){
	  ...
	  //$sql = "SELECT c_ubicacion.*, c_estado_registro.nombre as estado_registro_nombre FROM c_ubicacion 
	  //LEFT JOIN c_estado_registro ON c_ubicacion.estado_registro_id = c_estado_registro.estado_registro_id";
	  $sql = "SELECT c_ubicacion.*, c_centro_trabajo.nombre as centro_trabajo_nombre, c_estado_registro.nombre as estado_registro_nombre 
      FROM c_ubicacion 
      LEFT JOIN c_centro_trabajo ON c_ubicacion.centro_trabajo_id = c_centro_trabajo.centro_trabajo_id 
      LEFT JOIN c_estado_registro ON c_ubicacion.estado_registro_id = c_estado_registro.estado_registro_id";
  ...
  //traer todos los registros del centros de trabajo ------------------------------------------------------------------------
		...
		<div class="container-login100">
			...
			<div class="wrap-login100">
				...
				<div class="container-fluid">
				  <div class="row">
				    <div class="col-sm-3">
				       <div class="my_titulo"><h1>Catálogo de Ubicaciones</h1></div>
				    </div>
							...
							if($activar_busqueda_inicial){
								...
								if(count($records)>0){
									...
									foreach($records as $record){
										...
										echo '<tr>';
										echo '<td><input type="checkbox" id="checkbox_reg_'.$record->ubicacion_id.'">&nbsp;&nbsp;' . ($contador++) .'</td>';
										echo '<td>'. $record->ubicacion_id.'</td>';
										echo '<td>'.$record->fecha_registro.'</td>';
										echo '<td><div id="reg_div_id_'.$record->ubicacion_id.'">'.$record->nombre.'</div></td>';
										...
										if($activar_funcion_duplicar){
											echo '<button type="button" id="btn_duplicar_cascada_' . $record->ubicacion_id . '" class="btn my_btn btn-light btn_duplicar_cascada" data-container="body" data-toggle="popover" title=""  data-placement="left" data-content="" ' . $enable_component . '>';
											echo '<img class="icons24x24" src="images/icons/32x32/application_cascade.png" />';
											echo '</button>';
											
											echo '<button type="button" id="btn_duplicar_actualizar_' . $record->ubicacion_id . '" class="btn my_btn btn-light btn_duplicar_actualizar" data-container="body" data-toggle="popover" title=""  data-placement="left" data-content="" '.$enable_component.'>';
											echo '<img class="icons24x24" src="images/icons/32x32/application_double.png" />';
											echo '</button>';
										}

										echo '<button type="button" id="btn_editar_' . $record->ubicacion_id . '" class="btn my_btn btn-light btn_editar" data-container="body" data-toggle="popover" title=""  data-placement="left" data-content="" '.$enable_component.'>';
										echo '<img class="icons24x24" src="images/icons/32x32/application_edit.png" />';
										echo '</button>';
										
										echo '<button type="button" id="btn_borrar_' . $record->ubicacion_id . '" class="btn my_btn btn-light btn_borrar" data-container="body" data-toggle="popover" title=""  data-placement="left" data-content="" '.$enable_component.'>';
      ...
      <div class="modal-body">
		   ...
		   <div class="form-group">
		  		...
		  		<div class="my_modal_campo_container">
			  		...
			  		<div class="my_modal_campo"><select class="form-control my_form-control" id="se_centro_trabajo_id">
					    	<?php
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		   ...
		   <div class="form-group">
		  		...
		  		<div class="my_modal_campo_container">
		  			<div class="my_modal_buscar_cb" style="height: 53px;"><input type="checkbox" id="cb_buscar_campo_centro_trabajo_nombre"></div>
		  			<div class="my_modal_campo_label"><label for="se_buscar_campo_centro_trabajo_nombre_id">Estado del registro</label></div>
			  		<div class="my_modal_campo"><select class="form-control my_form-control" id="se_buscar_campo_centro_trabajo_nombre_id" disabled>
					    	<?php
								if( count($records_centro_trabajo) > 0 ){
									$contador = 1;
									foreach($records_centro_trabajo as $record){
      ...
      <div class="modal-body">
		 ...
		 <div class="form-group"  style="padding-left: 20px;">
        	...
        	<div style="display: flex; align-items: center;"><input type="checkbox" id="cb_modal_seleccion_campo_fecha_registro" my_campo_tabla="3"><label>&nbsp;&nbsp;Fecha Registro</label></div>
		  	...
		  	<div style="display: flex; align-items: center;"><input type="checkbox" id="cb_modal_seleccion_campo_centro_trabajo_nombre" my_campo_tabla="6"><label>&nbsp;&nbsp;Centro de Trabajo</label></div>
		  	<div style="display: flex; align-items: center;"><input type="checkbox" id="cb_modal_seleccion_campo_estado_registro" my_campo_tabla="7"><label>&nbsp;&nbsp;Estado Registro </label></div>
      	</div>
      	</div>
      	<div class="modal-footer">
        	<button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
