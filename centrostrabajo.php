...
if($activar_busqueda_inicial){
	 ...
	 $sql = "SELECT c_centro_trabajo.*, c_estado_registro.nombre as estado_registro_nombre FROM c_centro_trabajo 
	 LEFT JOIN c_estado_registro ON c_centro_trabajo.estado_registro_id = c_estado_registro.estado_registro_id";
 ...
 //obtenemos valores del rol -----------------------------------
  ...
  //1. admin   2. superusuario  3.invitado
		...
		<div class="container-login100">
			...
			<div class="wrap-login100">
				...
				<div class="container-fluid">
				  <div class="row">
				    <div class="col-sm-4">
				       <div class="my_titulo"><h1>Catálogo de Centros de Trabajo</h1></div>
				    </div>
				...
				<div style="/*overflow: auto; white-space: nowrap;*/">
					<table id="my_table_sorter" class="table table-bordered table-striped">
						<thead class="thead-dark"> <!-- add class="thead-light" for a light header -->
							<tr>
								<th>
									<input type="checkbox" id="checkbox_all_registers" data-toggle="popover" title="" data-placement="left" data-content="" data-html="true">&nbsp;&nbsp;#
								</th>
								<th>ID BD</th>
							...
							if($activar_busqueda_inicial){
								...
								if(count($records)>0){
									...
									foreach($records as $record){
										...
										echo '<tr>';
										echo '<td><input type="checkbox" id="checkbox_reg_'.$record->centro_trabajo_id.'">&nbsp;&nbsp;' . ($contador++) .'</td>';
										echo '<td>'. $record->centro_trabajo_id.'</td>';
										echo '<td>'.$record->fecha_registro.'</td>';
										echo '<td><div id="reg_div_id_'.$record->centro_trabajo_id.'">'.$record->nombre.'</div></td>';
										...
										if($activar_funcion_duplicar){	
											echo '<button type="button" id="btn_duplicar_cascada_' . $record->centro_trabajo_id . '" class="btn my_btn btn-light btn_duplicar_cascada" data-container="body" data-toggle="popover" title=""  data-placement="left" data-content="" ' . $enable_component . '>';
											echo '<img class="icons24x24" src="images/icons/32x32/application_cascade.png" />';
											echo '</button>';
											
											echo '<button type="button" id="btn_duplicar_actualizar_' . $record->centro_trabajo_id . '" class="btn my_btn btn-light btn_duplicar_actualizar" data-container="body" data-toggle="popover" title=""  data-placement="left" data-content="" '.$enable_component.'>';
											echo '<img class="icons24x24" src="images/icons/32x32/application_double.png" />';
											echo '</button>';
										}

										echo '<button type="button" id="btn_editar_' . $record->centro_trabajo_id . '" class="btn my_btn btn-light btn_editar" data-container="body" data-toggle="popover" title=""  data-placement="left" data-content="" '.$enable_component.'>';
										echo '<img class="icons24x24" src="images/icons/32x32/application_edit.png" />';
										echo '</button>';
										
										echo '<button type="button" id="btn_borrar_' . $record->centro_trabajo_id . '" class="btn my_btn btn-light btn_borrar" data-container="body" data-toggle="popover" title=""  data-placement="left" data-content="" '.$enable_component.'>';
...
<script type="text/javascript" src="js/centrostrabajo.js"></script>		
